...
function resolve(svg) {
  ...
  for (const [name, value] of Object.entries(palette)) {
    ...
    out = out.replace(new RegExp(`var\\(${name},\\s*[^)]+\\)`, "g"), value);
  }
  return out + "\n";
}
